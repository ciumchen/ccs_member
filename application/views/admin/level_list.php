                    ...
                    <div class="panel-body">
                        ...
                        <table class="table">
                            ...
                            <?php foreach ($level_list as $level){?>
                                <tr>
                                    <th><?php echo $level['id']?></th>
                                    <th><?php echo $level['uid']?></th>
                                    <th><span class="label label-success"><?php echo "VIP".$level['old_level']?></span></th>
                                    <th><label class="label label-primary"><?php echo "VIP".$level['new_level']?></label></th>
                                    <th><?php echo $level['create_time'];?></th>
                                    <!-- <th>
